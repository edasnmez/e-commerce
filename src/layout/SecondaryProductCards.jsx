...
function SecondaryProductCards() {
  return (
    <section className='bg-white font-montserrat '>
        <div className="flex gap-7 px-[189px] py-12 max-[420px]:px-4 max-[420px]:flex-col-reverse">
            ...
            <div className="w-1/3 max-[420px]:w-full">
                <img src="src/assets/spc.jpg" alt="" className="w-full h-full object-cover max-[420px]:object-contain"/>
            </div>
        </div>
